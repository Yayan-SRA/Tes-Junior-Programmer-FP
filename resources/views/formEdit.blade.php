...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <hr class="mb-3">
            <form action="{{ route('home.update', $item->id_produk) }}" method="post">
                @method('put')
                @csrf
                <div class="form-floating mb-3">
                    <input type="text"
                        ...
                        is-invalid
                    @enderror"
                        id="nama_produk" required value="{{ old('nama_produk', $item->nama_produk) }}" name="nama_produk">
                ...
                <div class="form-floating mb-3">
                    <input type="text"
                        ...
                        is-invalid
                    @enderror"
                        id="kategori" required value="{{ old('kategori', $item->kategori) }}" name="kategori">
                ...
                <div class="form-floating mb-3">
                    <input type="number"
                        ...
                        is-invalid
                    @enderror"
                        id="harga" required value="{{ old('harga', $item->harga) }}" name="harga">
    ...
    <script>
        const bisa = document.querySelector('#bisa');
        const tidak = document.querySelector('#tidak');
        let val = "{{ $item->status }}"
        if (val === 'bisa dijual') {
            tidak.selected = false;
            bisa.selected = true;
        } else {
            bisa.selected = false;
            tidak.selected = true;
